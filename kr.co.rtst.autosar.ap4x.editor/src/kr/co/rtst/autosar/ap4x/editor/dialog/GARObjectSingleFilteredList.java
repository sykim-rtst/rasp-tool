...
public class GARObjectSingleFilteredList extends FilteredTree{
	 ...
	 */
	public GARObjectSingleFilteredList(Composite parent, FormToolkit toolkit) {
	 ...
	 * @param treeStyle
	 */
	public GARObjectSingleFilteredList(Composite parent, FormToolkit toolkit, int treeStyle) {
	 ...
	 */
	public GARObjectSingleFilteredList(Composite parent, FormToolkit toolkit, int treeStyle, PatternFilter filter) {
