...
/**
 * 검색가능한 체크박스 테이블(트리)을 제공하는 객체
 * @author thkim
 *
 */
public class ARPackageFilteredTree extends FilteredTree{
	 ...
	 */
	public ARPackageFilteredTree(Composite parent, FormToolkit toolkit) {
	 ...
	 * @param treeStyle
	 */
	public ARPackageFilteredTree(Composite parent, FormToolkit toolkit, int treeStyle) {
	 ...
	 */
	public ARPackageFilteredTree(Composite parent, FormToolkit toolkit, int treeStyle, PatternFilter filter) {
	...
	protected TreeViewer doCreateTreeViewer(Composite actParent, int style) {
		int treeStyle = style | /*SWT.CHECK |*/ SWT.SINGLE | SWT.V_SCROLL | SWT.H_SCROLL | SWT.BORDER;
		Tree tree = null;
		if (fToolkit != null) {
	...
	protected WorkbenchJob doCreateRefreshJob() {
		...
		return super.doCreateRefreshJob();
	}
